<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportUploadDetails.aspx.cs" Inherits="FileShareApp.Admin.ReportUploadDetails" %>
...
&nbsp;<br />--%>
       ...
       <asp:DropDownList ID="ddlUsers" runat="server" DataSourceID="SqlDataSource1" 
                ...
                ondatabinding="ddlUsers_DataBinding" >
    ...
    <rsweb:ReportViewer ID="rptListUpload" runat="server" Width="90%" Height="100%">
    </rsweb:ReportViewer>
    </form>
</body>
</html>
