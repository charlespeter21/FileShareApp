...
{
    public partial class ReportAllFiles : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            CrystalReportViewer_AllFiles.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
            ...
            rptDoc.Load(Server.MapPath("~/Reports/ListAllFiles.rpt"));
            ...
            CrystalReportViewer_AllFiles.ReportSource = rptDoc;
        }
        ...
        public DataTable getAllOrders()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "sp_FileDetailsReport";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = Con;
                ds = new DataSet();
                adapter = new SqlDataAdapter(cmd);
                adapter.Fill(ds, "UploadFile");
            }
            catch (Exception ex)
            {
